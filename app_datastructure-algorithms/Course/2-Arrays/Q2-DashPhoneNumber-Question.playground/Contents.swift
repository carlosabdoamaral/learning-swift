...
func solution(_ S : String) -> String {
    var newString = removeCharacters(S)
    newString = buildNewString(newString)
    
    return newString
}

func removeCharacters(_ S: String) -> String {
...
func buildNewString(_ S: String) -> String {
    ...
    stringToReturn.remove(at: String.Index(utf16Offset: 0, in: stringToReturn))
